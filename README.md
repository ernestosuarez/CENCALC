...
**-step**  _STEP_SIZE_    Default: 5 (degrees) 

    PDF minimization step size:  xn+1=xn - STEP_SIZE * GRADIENT 
    
**-crit**  _CONVERGENCE_THRESHOLD_  Default: 1.e-4 

    Gradient convergence threshold for the PDF minimizations.

**-maxitr** _MAX_NUMBER_OF_ITERATIONS_   Default: 1000 

    Maximum number of iteration for PDF minimizations. 
    
**-maxconf** _MAX_NUMBER_OF_CONFORMERS_ Default: 3 
